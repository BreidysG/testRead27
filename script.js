document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
        ...
        {
            question: "¿Por qué estaba la gallina en la cocina?",
            answers: [
                "Se escondía del dueño de la casa",
                "La iban a matar para el almuerzo",
                "Estaba enferma",
                "En ese lugar vivía"
            ],
            correctAnswer: "La iban a matar para el almuerzo"
        },
        {
            question: "¿Por dónde huye la gallina de la cocina?",
            answers: [
                "El mesón",
                "La puerta principal",
            ...
            correctAnswer: "El muro de la terraza"
        },
        {
            question: "¿Qué le pasó a la gallina después que fue atrapada?",
            answers: [
                "La mataron",
                "Se murió",
                "Puso un huevo",
                "No fue atrapada nunca"
            ],
            correctAnswer: "Puso un huevo"
        },
        {
            question: "¿Quiénes se opusieron para que no mataran a la gallina?",
            answers: [
                "La niña y la mamá",
                "El niño y el papá",
                "Los papás",
            ...
            correctAnswer: "La niña y el papá"
        }
    ];
